...
function Register-Task {
    ...
    $trigger = New-ScheduledTaskTrigger -Once -At (Get-Date) -RepetitionInterval (New-TimeSpan -Minutes $IntervallMin) -RepetitionDuration (New-TimeSpan -Hours 23 -Minutes 55)
